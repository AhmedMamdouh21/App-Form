...
function AppComponent_small_10_Template(rf, ctx) { if (rf & 1) {
...
function AppComponent_span_15_small_1_Template(rf, ctx) { if (rf & 1) {
...
function AppComponent_span_15_small_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 25);
...
function AppComponent_span_20_small_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "This is Mobile is invalid");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function AppComponent_span_20_small_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 25);
...
function AppComponent_span_25_small_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Use 8 or more characters or numbers for your password");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function AppComponent_span_25_small_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "small", 25);
...
class AppComponent {
    ...
    onAddHobbies() {
        const control = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required);
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 35, vars: 7, consts: [[1, "container"], [1, "row", "py-md-5", "py-3", "min-vh-100", "align-items-center", "justify-content-center"], [1, "col-md-8", "p-5", "form-wrap"], [1, "text-white", "text-center", "mb-5"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "text", "formControlName", "username", 1, "form-control"], ["for", "username"], ["class", "form-text text-danger", 4, "ngIf"], ["type", "email", "formControlName", "email", 1, "form-control"], ["for", "email"], [4, "ngIf"], ["type", "number", "formControlName", "phone", 1, "form-control"], ["for", "phone"], ["type", "password", "formControlName", "password", 1, "form-control"], ["for", ""], ["formArrayName", "hobbies", 1, "mb-3"], ["type", "button", 1, "btn", "btn-outline-dark", "text-white", "mb-3", 3, "click"], ["class", "form-group", 4, "ngFor", "ngForOf"], [1, "d-flex", "justify-content-end"], ["type", "submit", 1, "btn", "btn-submit", 3, "disabled"], [1, "btn-anim-top-right"], [1, "btn-anim-bottom-left"], [1, "form-text", "text-danger"], ["class", "text-danger", 4, "ngIf"], [1, "text-danger"], ["type", "text", 1, "form-control", 3, "formControlName"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AppComponent_Template_form_ngSubmit_5_listener() { return ctx.onSubmit(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_27_listener() { return ctx.onAddHobbies(); });
...
module.exports = __webpack_require__(/*! F:\Programming\Angular\app-form\src\main.ts */"./src/main.ts");
